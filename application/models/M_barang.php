<?php
   ...
   public function sayur(){
    return $this->db->where('kategori','sayuran')->from("tb_barang")->count_all_results();
   }
   public function buah(){
    return $this->db->where('kategori','buah')->from("tb_barang")->count_all_results();
   }
   public function lainnya(){
    return $this->db->where('kategori','lainnya')->from("tb_barang")->count_all_results();
   }
