        ...
        <form action="<?php echo base_url() . 'admin/data_barang/update'; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="kategori">
                    <option <?php if ($brg->kategori == 'sayuran') echo 'selected'; ?>> Sayuran</option>
                    <option <?php if ($brg->kategori == 'buah') echo 'selected'; ?>> Buah</option>
                    <option <?php if ($brg->kategori == 'lainnya') echo 'selected'; ?>> Lainnya</option>
                </select>
            </div>
            <div class="form-group">
